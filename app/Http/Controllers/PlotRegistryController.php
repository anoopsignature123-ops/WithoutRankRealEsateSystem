...
class PlotRegistryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('plot-registry.index', compact('projects'));
    }

    public function getBlocks($projectId)
    {
        return response()->json(Block::where('project_id', $projectId)->get());
    }
    ...
    {
        $booking = CustomerBooking::with(['primaryDetail', 'payment', 'plotSaleDetail'])
        ...
        return response()->json([
            ...
            'payment' => [
                ...
                'date' => optional($booking->payment?->created_at)->format('d/m/Y'),
                'mode' => ucfirst($booking->payment?->payment_mode),
