    ...
    */
    public function getPlots(
        ...
        $plots = PlotDetail::where(
            ...
            ->whereHas(
                'plotSaleDetail.customerBooking.payments',
                function ($query) {
            ...
            $payments->map(
                function ($payment) {
                    return [
                        ...
                        'date' => $payment->created_at ? $payment
                            ->created_at
                            ->format(
                                'd-M-Y'
                            )
