...
<body>
    ...
    <table class="header-table">
        <tr>
            <td>
                <div class="title">My Payout Details</div>
                <div class="subtitle">Self and team commission payout records</div>
            </td>
            <td class="date">
                Generated Date<br>
    ...
    <table class="summary-table">
        <tr>
            ...
            <td>
                <div class="summary-label">Self Commission</div>
                <div class="summary-value summary-green">
                    Rs. {{ number_format($commissions->where('commission_type', 'self')->sum('commission_amount'), 2) }}
                </div>
            </td>

            <td>
                <div class="summary-label">Team Commission</div>
                <div class="summary-value summary-green">
                    Rs. {{ number_format($commissions->where('commission_type', 'team')->sum('commission_amount'), 2) }}
                </div>
            </td>
    ...
    <table class="report-table">
        <thead>
            <tr>
                <th style="width:4%;">#</th>
                <th style="width:11%;">Generated</th>
                <th style="width:13%;">Source</th>
                <th style="width:12%;">Customer</th>
                <th style="width:9%;">Booking</th>
                <th style="width:14%;">Plot Details</th>
                <th style="width:7%;">Type</th>
                <th style="width:9%;" class="text-right">Business</th>
