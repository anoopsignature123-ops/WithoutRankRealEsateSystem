...
@section('content')
    ...
    <div class="container-fluid mt-4 transaction-page">
        <div class="transaction-hero mb-4">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    <span class="transaction-icon"><i class="bi bi-diagram-2"></i></span>
                    <div>
                        <span class="text-success fw-bold text-uppercase small">Associate Network</span>
                        <h3 class="fw-bold mb-1 text-dark">My Downline</h3>
                        <p class="text-muted mb-0 small">View associates placed under your network structure.</p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="transaction-card h-100 border-start border-4 border-success">
                    <div class="transaction-card-body py-3">
                        <small class="text-muted fw-semibold">Downline Associates</small>
                ...
                <div class="transaction-section-title">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Filter downline associates by associate ID and joining date range.</small>
                        </div>
                    </div>
                </div>

                <form method="GET" action="{{ route('associate-panel.my-downline') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-3 col-md-6 d-flex gap-2">
                            ...
                            <a href="{{ route('associate-panel.my-downline') }}" class="btn btn-outline-secondary flex-fill">
            ...
            <div class="transaction-card-body">
                <div class="transaction-section-title">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1">Downline Associate Records</h5>
                            <small class="text-muted">Downline team details with sponsor and placement information.</small>
                        </div>
                    </div>
                ...
                <div class="transaction-table-wrap">
                    <table class="table table-hover align-middle mb-0 transaction-table w-100" id="downlineAssociateTable">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Associate</th>
                        ...
                        <tbody>
                            @forelse ($associates as $key => $item)
                                @php $modalId = 'downlineAssociateModal' . $item->id; @endphp
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>
        ...
        @foreach ($associates as $item)
            <div class="modal fade" id="downlineAssociateModal{{ $item->id }}" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-body p-0">
                            ...
                            <div class="customer-receipt-body">
                                <div class="customer-receipt-panel">
                                    ...
                                    <div class="customer-receipt-line"><span>Under Place</span><strong>{{ $item->under_place_id ?? '-' }}</strong></div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            if ($('#downlineAssociateTable tbody tr td[colspan]').length === 0) {
                $('#downlineAssociateTable').DataTable({
                    pageLength: 10,
                    ordering: true,
                    searching: true,
                    responsive: false,
                    ...
                    language: {
                        search: "_INPUT_",
                        searchPlaceholder: "Search downline associates..."
                    }
                });
            }
        });
