                    ...
                    <tbody>
                        ...
                        @foreach ($receipts as $key => $receipt)
                            <tr>
                                ...
                                <td>
                                    {{ $receipt->customerBooking->customer_code }}
                                </td>

                                <td>
                                    {{ $receipt->customerBooking->primaryDetail?->name }}
                                </td>

                                <td>
                                    ₹{{ $receipt->booking_amount }}
                                </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            `);
                ...
                $.get(
                    "{{ route('admin.receipt-reprint.customers', ':id') }}"
                    .replace(':id', plotId),
